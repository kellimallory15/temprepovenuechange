    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(choices=[('Senior Portrait Package', 'Senior Portrait Package'), ('Couples & Engagements Package', 'Couples & Engagements Package'), ('Family Package', 'Family Package')], default='Senior Portrait Package', max_length=50)),
